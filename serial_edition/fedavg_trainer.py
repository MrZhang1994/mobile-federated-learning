...
# ================================================================================================
            print(FPF2_idx_lst)
            if round_idx == 0:
                client_indexes, local_itr = scheduler.sch_mpn_initial(round_idx, self.time_counter)
            else:
                client_indexes, local_itr = scheduler.sch_mpn(round_idx, self.time_counter, loss_locals, FPF2_idx_lst[0])
# ================================================================================================
            # time.sleep(0.5)
